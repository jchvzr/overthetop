    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Formulario para creacion de nuevo usuario</h5>
            ...
            <div class="ibox-content">
                ...
                <form id="form" action="/userstore" class="wizard-big"method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control required" value="{{ old('password') }}" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Confirma el password *</label>
                                    <input id="confirm" name="confirm" type="password" class="form-control required" value="{{ old('confirm') }}" data-match="#password" required>
                                </div>
                            </div>
                          </div>
