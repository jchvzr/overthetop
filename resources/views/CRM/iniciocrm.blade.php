            ...
            <div class="panel-heading">
                ...
                <div class="panel-options">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#tab-4">Marcacion</a></li>
                        <li class=""><a id="elementobuscado" data-toggle="tab" href="#tab-1">Datos generales del cliente</a></li>
                   ...
                   <div id="tab-4" class="tab-pane active">
                     <div class="row">
                       <div class="col-lg-4">
                           <div class="form-group">
                               <label>Cuenta: </label>
                               <input id="mcustomerid" name="mcustomerid" type="text" class="form-control" disabled="disabled">
                           </div>
                       </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Nombre: </label>
                                 <input id="mnombreCliente" name="mnombreCliente" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Domicilio casa: </label>
                                 <input id="mcalleCasa" name="mcalleCasa" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Colonia casa: </label>
                                 <input id="mcoloniaCasa" name="mcoloniaCasa" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         ...
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Ciudad casa: </label>
                                 <input id="mciudadCasa" name="mciudadCasa" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>CP casa: </label>
                                 <input id="mcpCasa" name="mcpCasa" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Domiclio trabajo: </label>
                                 <input id="mcalleTrabajo" name="mcalleTrabajo" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Colonia trabajo: </label>
                                 <input id="mcoloniaTrabajo" name="mcoloniaTrabajo" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         ...
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Ciudad trabajo: </label>
                                 <input id="mciudadTrabajo" name="mciudadTrabajo" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>CP trabajo: </label>
                                 <input id="mcpTrabajo" name="mcpTrabajo" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Tel&eacute;fono1: </label>
                                 <input id="mtelefono1" name="mtelefono1" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Tel&eacute;fono2: </label>
                                 <input id="mtelefono2" name="mtelefono2" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Tel&eacute;fono3: </label>
                                 <input id="mtelefono3" name="mtelefono3" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Tel&eacute;fono4: </label>
                                 <input id="mtelefono4" name="mtelefono4" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom1: </label>
                                 <input id="mcustom1" name="mcustom1" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom2: </label>
                                 <input id="mcustom2" name="mcustom2" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom3: </label>
                                 <input id="mcustom3" name="mcustom3" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom4: </label>
                                 <input id="mcustom4" name="mcustom4" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom5: </label>
                                 <input id="mcustom5" name="mcustom5" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom6: </label>
                                 <input id="mcustom6" name="mcustom6" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom7: </label>
                                 <input id="mcustom7" name="mcustom7" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom8: </label>
                                 <input id="mcustom8" name="mcustom8" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom9: </label>
                                 <input id="mcustom9" name="mcustom9" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                         <div class="col-lg-4">
                             <div class="form-group">
                                 <label>Custom10: </label>
                                 <input id="mcustom10" name="mcustom10" type="text" class="form-control" disabled="disabled">
                             </div>
                         </div>
                     </div>
                   </div>
